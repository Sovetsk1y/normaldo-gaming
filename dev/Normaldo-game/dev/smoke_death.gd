...
func _initialize() -> void:
	...
	# выбирает английский: половина проверок начинает падать не потому, что
	# что-то сломалось, а потому, что она заговорила на другом языке.
	#
	# Ровно так этот тест и упал в контейнере с английской локалью.
	#
