...
const HEADS : Dictionary = {
	...
	"kuss": { "scale": 2.000, "head": 0.5000, "head_h": 0.5400, "off": [Vector2(0.0225, 0.0275), Vector2(-0.0100, 0.0450), Vector2(-0.1400, -0.0200), Vector2(-0.1150, 0.0100)], "box": [Vector2(0.5000, 0.5420), Vector2(0.6260, 0.5840), Vector2(0.8800, 0.5840), Vector2(0.9120, 0.7620)], "head_wh": [Vector2(0.5000, 0.5400), Vector2(0.6250, 0.5850), Vector2(0.6250, 0.5850), Vector2(0.7050, 0.7650)] },
	...
	"pirate": { "scale": 1.379, "head": 0.7250, "head_h": 0.6250, "off": [Vector2(0.0100, -0.0250), Vector2(0.0375, -0.0475), Vector2(0.0825, -0.0800), Vector2(0.0400, -0.1325)], "box": [Vector2(0.8672, 0.8828), Vector2(0.9121, 0.8389), Vector2(0.9580, 0.8428), Vector2(1.0000, 0.8496)], "head_wh": [Vector2(0.7250, 0.6250), Vector2(0.7200, 0.6200), Vector2(0.7200, 0.6250), Vector2(0.7050, 0.6600)] },
