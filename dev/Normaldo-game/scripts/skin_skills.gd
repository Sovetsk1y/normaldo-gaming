...
const DATA : Dictionary = {
	...
	"tyson": {
		"skills": [], "resists": [],
		# КД 2 с — короче всех остальных мили. У Тайсона спелл самый скромный по
		# охвату: один хук в точку тапа, без летящего кулака и без радиуса
		# викинга. Компенсируется он частотой, иначе это просто худший удар.
		"ability": { "type": SPELL, "id": "glove_punch", "combat": MELEE, "cd": 2.0,
