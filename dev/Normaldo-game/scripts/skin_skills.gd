...
const DATA : Dictionary = {
	...
	"wizard": {
		...
		"ability": { "type": SPELL, "id": "wand_shot", "combat": RANGED, "cd": 2.0,
			...
			# Раньше здесь стояло «самый быстрый спелл в игре». С «Разменом»
			# классики откат 2 секунды перестал быть уникальным, и строка врала.
			"desc": "Магический шар каждые 2 секунды — откат самый короткий в игре" },
		"unique": {},
	},
