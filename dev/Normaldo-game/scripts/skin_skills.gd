...
const DATA : Dictionary = {
	...
	"wizard": {
		...
		"ability": { "type": SPELL, "id": "wand_shot", "combat": RANGED, "cd": 2.0,
			...
			# Про «самый быстрый откат» здесь больше ни слова: с «Разменом»
			# классики и паутиной Спайдера две секунды уже не уникальны, и
			# любая формулировка про первенство врёт.
			"desc": "Магический шар летит в сторону тапа каждые 2 секунды" },
		"unique": {},
	},
