...
const SKINS : Array = [
	...
	{
		"id":        "glasses",
		# ИМЯ — «ГЛАЙД», а id остался «glasses». Id лежит в сейвах игроков, в
		# записях таблицы лидеров и в ключах прогресса скина; переименовать его
		# значит потерять всё это у всех, кто уже играл. Имя видит игрок, id —
		# только код.
		"name_ru":   "ГЛАЙД",
		"rarity":    EPIC,
		"price":     15000,
