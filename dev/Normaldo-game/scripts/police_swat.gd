...
# Размер головы бойца. Мельче Нормальдо: их бывает трое разом, и в его рост они
# закрыли бы пол-экрана.
const HEAD_PX   : float = 64.0
const SHIELD_PX : float = 66.0
const M16_PX    : float = 78.0
const HAND_PX   : float = 34.0
