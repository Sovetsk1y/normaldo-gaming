...
#
# И она ПРОЗРАЧНАЯ. Была белая, и вокруг головы мелькал голубой квадрат: материал
# компилируется лениво, и в первый раз узел успевает нарисоваться носителем —
# белым квадратиком, растянутым на весь размер сферы. Прозрачный носитель этот
# кадр гасит, а самой сфере всё равно: шейдер присваивает COLOR целиком.
#
